...
| Scope | Columns |
| --- | --- |
| Session | `schema_version`, `session_id`, `dataset_name`, `annotator`, `annotation_mode`, `session_dot_target_count`, marker diameter/fraction and animation fields, five `session_hotkey_*` fields, timestamps |
